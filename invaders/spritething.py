...
def main(size, invaders, imgSize, spriteName):
    ...
    origImage.save(f'sprites/invader-{spriteName}-{size}x{size}-{invaders}-{imgSize}.jpg')


if __name__ == "__main__":
  main(int(sys.argv[1]), int(sys.argv[2]), int(sys.argv[3]), str(sys.argv[4]))
